...
class Downloader:
    ...
    PLATFORM_PREFIXES = {
        "YouTube": ["https://www.youtube.com/watch?v=", 'https://youtube.com/watch?v', "https://youtu.be/", "https://www.youtube.com/shorts/", "https://youtube.com/shorts/"],
    ...
    def download(self, platform: str, url: str, filename: str) -> str:
        ...
        if platform == "YouTube":
            time_limit = 6000
            if youthon.Video(url).length_seconds > time_limit:
                raise ValueError(f"Скачивание доступно только для видео короче {time_limit/60} минут.")
